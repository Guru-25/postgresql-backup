...
echo "OAUTH_APP_KEY=${DROPBOX_OAUTH_APP_KEY}" >> ~/.dropbox_uploader
echo "OAUTH_APP_SECRET=${DROPBOX_OAUTH_APP_SECRET}" >> ~/.dropbox_uploader
echo "OAUTH_REFRESH_TOKEN=${DROPBOX_OAUTH_REFRESH_TOKEN}" >> ~/.dropbox_uploader
